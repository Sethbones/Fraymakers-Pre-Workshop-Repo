// API Script
//there's basically nothing of note in here since most things are handled externally
//var bottomswap = null;
//var topswap = null;
...
//Runs on object init
function initialize(){
    match.createProjectile("swappablebottom", self);
    match.createProjectile("swappabletop", self);
    Engine.log("E");
