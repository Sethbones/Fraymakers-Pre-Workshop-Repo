{
	...
	//public::welltaro.welltaro
	//public::orcane.orcane
	//something for watcher
	//something for fishbunjin
	...
	//attackVoiceIds: [	], //List of attack voice content ids. Calls to playAttackVoice() will choose one of these audio clips at random. //TODO
	...
	doubleJumpSpeeds: [ //array of a character’s double jumps. Values less or equal to 0 have no effect. The amount of entries mean how many double jumps the character will have.    //if no value is put in here the game crashes so if you need to make a character with 1 jump set the value in the array to 0
		12
	],
	...
	//grabAirType: GrabAirType.AERIAL, //The behaviour of performing GRAB while midair 
	//grabairtype options:
	//AERIAL //The engine will perform an aerial attack, also taking into account the input direction
	...
	//initialGlideSpeed: 0, //Speed the character starts gliding at. value above 1 to enable gliding. //doesn't seem to work
	...
	aerialFriction: 0.25, //The deceleration speed of the game object if forward is not held and they’re in the air. //for some reason set to minus by default presumably accidental.
